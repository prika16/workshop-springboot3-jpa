package com.cursospring.CursoSpringNelio.config;
...
import com.cursospring.CursoSpringNelio.entities.Payment;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {// tudo que colocar dentro desse método vai executar quando a aplicação for iniciada
		...
		p1.getCategories().add(cat2); // fazendo associação entre os objetos
		...
		o1.setPayment(pay1); //associando o pedido 1 com pagto 1
